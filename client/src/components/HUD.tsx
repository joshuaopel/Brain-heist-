  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 4, minWidth: 220 }}>
      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13, fontWeight: 700 }}>
        ...
        <span style={{ opacity: 0.7 }}>{ideas} ideas</span>
      </div>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <BrainBar ideas={redIdeas} level={redLevel} color="#ef4444" label="🔴 Red Brain" />
        ...
        <BrainBar ideas={blueIdeas} level={blueLevel} color="#3b82f6" label="🔵 Blue Brain" />
      </div>
